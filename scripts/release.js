...
/**
 * Intelligent Release Management System for TraceLog Library
 *
...
class ReleaseManager {
  ...
  async run() {
    try {
      this.log.title('TraceLog Library Release Manager');
...
function showHelp() {
  console.log(`
${colors.bright}TraceLog Library Release Manager${colors.reset}
