...
- Enhance session management with renewal mode and stale session detection ([275f834](../../commit/275f8343a4e7540895dde0d10a0f6be5a4f1d582))
- Add session renewal mode to handle timeouts and improve session management ([e935eb5](../../commit/e935eb50bb032076e7f8e60ae097a9a728c24565))
- Implement session-level referrer and UTM parameter tracking for improved event attribution ([fd6b3c6](../../commit/fd6b3c6047c6b0e229d291f153bdae89cc051487))

### 🔧 Other Changes

- Release v2.1.2 ([a761952](../../commit/a761952d4f89042b0a1fe52e1ae5aa217816edd8))
- Merge pull request #76 from nacorga/release/20260104.1 ([c4aa4eb](../../commit/c4aa4eb837f2ace07659d7ad27185c36d862d8b9))
- Update qs package to version 6.14.1 in package-lock.json ([123ea20](../../commit/123ea2095f20f27a2d6328a9bd9ee6d9403ed7ca))
...
**Full Changelog**: https://github.com/nacorga/tracelog-lib/compare/v2.1.1...v2.1.2

## [2.1.1] - 2025-12-12

### ✨ Features

- Enhance domain comparison and referrer detection with new utility methods ([a80900e](../../commit/a80900e71f8f4fe6dcc5f895996f509415f175a6))
- Implement external referrer detection to improve traffic source attribution ([1db6e0c](../../commit/1db6e0c4452aa16ae9f2838b5651997538decfab))

### 🐛 Bug Fixes

- Improve error handling in referrer parsing and add integration tests for SESSION_START referrer detection ([8e163d2](../../commit/8e163d2a59a073797a680b12cba0f2bf4706bb3f))

### 🧪 Tests

- Add setup and teardown for document referrer and window location in external referrer detection tests ([89deb2c](../../commit/89deb2c103cc9035e3e34f6dc063bec64d89ab9a))

### 🔧 Other Changes

- Release v2.1.1 ([d0255af](../../commit/d0255af8bf29011238c726502c226e7688571f4b))
- Merge pull request #74 from nacorga/release/20251212.1 ([fc77151](../../commit/fc77151f2f634bd72ca08b4b2dbc56c9e134ded9))
...
**Full Changelog**: https://github.com/nacorga/tracelog-lib/compare/v2.1.0...v2.1.1

## [2.1.0] - 2025-12-11

### ✨ Features

- Add page_view event tracking and data preservation across event pipeline ([87173a5](../../commit/87173a5cdcd7a400fecc37a9ad1fbaf24d97c6ea))
- Enhance logging and device detection capabilities, improve QA mode handling, and update URL normalization error reporting ([852f2e1](../../commit/852f2e16f084431e16b53f2f62bcd25d489678c7))
- Improve device detection and enhance logging policy ([1e49dfb](../../commit/1e49dfbf28a0b1fe6f439e5ba22141256a986ad3))

### ♻️ Refactoring

- Update QA mode detection logic to avoid circular dependency with mode.utils.ts and ensure synchronization of changes ([7eb9f56](../../commit/7eb9f568e4a6df694fef3ea13b62c88a52fe38d7))
- Update logging visibility for QA mode and improve URL normalization error handling ([4691310](../../commit/4691310fd81d55d01c6afbaf4de48b1bab9df707))

### 🔧 Other Changes

- Release v2.1.0 ([59d21e7](../../commit/59d21e75e17fa17db024cdded7ceec7b965dbe82))
- Merge pull request #73 from nacorga/release/20251208.1 ([a415059](../../commit/a415059760a4d6e5f802fb651deb583fa276ab61))
- Merge pull request #72 from nacorga/refactor/logging ([5cdcd3e](../../commit/5cdcd3e88980db0e739971a43d3ee3f495bb722e))
...
**Full Changelog**: https://github.com/nacorga/tracelog-lib/compare/v2.0.3...v2.1.0

## [2.0.3] - 2025-11-24

### ♻️ Refactoring

- Remove disabledEvents configuration in favor of beforeSend transformer for event filtering, ensuring all events are captured locally while allowing selective exclusion from custom backend sends ([38a8ca7](../../commit/38a8ca7e13e4675cb67b380055a44d5dbffd02ad))
- Restructure disabledEvents configuration for custom backend integration, ensuring events are captured locally while allowing selective exclusion from backend sends ([ff8ab4e](../../commit/ff8ab4e61cc5b8b3bd6047c53e1ef383fc272b37))

### 🔧 Other Changes

- Release v2.0.3 ([f1c64a8](../../commit/f1c64a8a64720a9e137301425eff91b22ded31dc))
- Merge pull request #71 from nacorga/release/20251124.1 ([404b177](../../commit/404b17713889699988ab02ce4fdef7cc0ed6a5ac))
- Merge pull request #70 from nacorga/feature/disable-events-by-integration ([75229bc](../../commit/75229bc3e23a139b6d13c979911790d603da3438))
...
**Full Changelog**: https://github.com/nacorga/tracelog-lib/compare/v2.0.2...v2.0.3

## [2.0.2] - 2025-11-20

### ♻️ Refactoring

- Enhance optimistic removal logic and update event logging for better clarity and resilience ([6e79239](../../commit/6e79239fc23f532507126786b604bacf77b160c2))
- Update event removal logic to allow removal if any integration succeeds, improving resilience against failures ([6bf72aa](../../commit/6bf72aaa7e7279e13219e0b3c87a648f9ffbe25a))
- Change event removal logic to require all integrations to succeed before removing events from the queue ([874a63e](../../commit/874a63e73f28f281626d2023f41611ed4ec85a89))

### 🔧 Other Changes

- Release v2.0.2 ([d5a4db6](../../commit/d5a4db630fe76237fafc728fb1c78a71639966af))
- Merge pull request #69 from nacorga/hotfix/20112025.1 ([b247318](../../commit/b247318141de58124dc464beb2ac48a33fa54ce2))
...
**Full Changelog**: https://github.com/nacorga/tracelog-lib/compare/v2.0.1...v2.0.2

## [2.0.1] - 2025-11-19

### 🐛 Bug Fixes

- Reset hasStartSession in global state during session teardown ([1ea6df5](../../commit/1ea6df59bef621ded417ccbf9db6a7945257faaf))

### 🔧 Other Changes

- Release v2.0.1 ([054e784](../../commit/054e784fd6e8717b0afa85f7a4a44c261e1f5afe))
- Tracelog.js alignment ([c723821](../../commit/c7238213a9b854940ed64f45870f09cd275502b5))
- Merge pull request #68 from nacorga/hotfix/20251119.1 ([7a6da0d](../../commit/7a6da0df65e0851aef6df66f9d00041456e321a8))
...
**Full Changelog**: https://github.com/nacorga/tracelog-lib/compare/v2.0.0...v2.0.1

## [2.0.0] - 2025-11-19

### ♻️ Refactoring

- Remove SESSION_END event handling and enhance session lifecycle management ([0cc912e](../../commit/0cc912ee3528e1003e3c56415a000e03a87de5de))
- Enhance session management and request handling ([c63c3d8](../../commit/c63c3d85d18969331a53da42d6ac319e8c783258))
- Remove SESSION_END event handling and improve session management ([0cd64bf](../../commit/0cd64bf2f86ae5c644ae7dfe21b0451c73f8ae8f))

### 🔧 Other Changes

- Release v2.0.0 ([faca200](../../commit/faca200b8d063821d5881b9b2837fb91153a754c))
- Merge pull request #67 from nacorga/release/20251118.1 ([05513e1](../../commit/05513e1ebc098bc3fedbc47a057290a5d54f7f82))
- Update dependencies in package-lock.json ([2e27931](../../commit/2e279318fdbee03c81182f7a958f69704e92e6f6))
- Merge pull request #66 from nacorga/feature/session-end-remove ([a017ced](../../commit/a017ced339f2f876a6b4dd943a3d00915d6ae3c2))
...
**Full Changelog**: https://github.com/nacorga/tracelog-lib/compare/v1.8.1...v2.0.0

## [1.8.1] - 2025-11-17

### ✨ Features

- Implement clock skew protection for timestamp generation ([1016cf1](../../commit/1016cf1211babd1fa4919b2a3bdffd0ed0b30e2d))

### 🐛 Bug Fixes

- Ensure lastEventTimestamp is always updated to reflect the current timestamp in UUID generation ([def7e37](../../commit/def7e37d73982bfe6d7c10afd4082688f7fd8681))

### 🔧 Other Changes

- Release v1.8.1 ([f0395bc](../../commit/f0395bc5e67a37ee47c9b08f8f700f759fc88451))
- Merge pull request #65 from nacorga/release/20251117.2 ([88b8cae](../../commit/88b8caec199686c6027dae8ec75689fb7a60ad4f))
...
**Full Changelog**: https://github.com/nacorga/tracelog-lib/compare/v1.8.0...v1.8.1

## [1.8.0] - 2025-11-17

### ✨ Features

- Enhance event tracking and management with new TimeManager and idempotency features ([04e4095](../../commit/04e4095363274554285722ef711633128c01f907))

### 🐛 Bug Fixes

- Respect manual version type selection in GitHub workflow ([d488288](../../commit/d4882885e7f6bc985eb23ccb3f5f0b74679acac1))

### 🧪 Tests

- Adjust timestamp assertions in EventManager tests for improved accuracy ([6d96782](../../commit/6d96782caaaf3abfac400a5ee90ba06da3f954e6))
- Update clock skew assertion in TimeManager tests for improved accuracy ([e38dd83](../../commit/e38dd83d6840f74b928a2869f6bd34c8d4011e77))

### ♻️ Refactoring

- Extend TimeManager to inherit from StateManager for improved state management ([ba42461](../../commit/ba424613d3d894925b7c256b412ebdaa7d89af67))
- Update idempotency token generation and improve TimeManager SSR safety ([eadb828](../../commit/eadb8288400d2b31ad1592dc02e7c22eaea722da))

### 🔧 Other Changes

- Release v1.8.0 ([489cafc](../../commit/489cafc6815f8827513d1509acb7313107489315))
- Merge pull request #64 from nacorga/release/20251117.1 ([c70c0a7](../../commit/c70c0a747623ab40877d8ca7f0a60246c31d7272))
...
**Full Changelog**: https://github.com/nacorga/tracelog-lib/compare/v1.7.0...v1.8.0
...
- Release v1.7.0 ([49f55c9](../../commit/49f55c9e07dd0c98fd186a3060e1bbe05b0ca0c5))
...
- Release v1.6.1 ([c0f11c8](../../commit/c0f11c811311773e3d27bb63e5257fce3dc76115))
...
- Release v1.6.0 ([907bc71](../../commit/907bc714ab1fdbb5ee39f1ee64d98f3102001fbc))
...
- Release v1.5.0 ([a6fe2d8](../../commit/a6fe2d87f1dad47b99916009e510334f75689af1))
...
- Release v1.4.0 ([e32eb43](../../commit/e32eb430811a822965b41df53fe47bc5646b78dd))
...
- Release v1.3.0 ([a53c2be](../../commit/a53c2be726e8d2dc7f3d311a32c96bbec824f646))
...
- Release v1.2.0 ([0e27d36](../../commit/0e27d36d78d08c5f3874481b8fbf00e82951cce6))
...
- Release v1.1.1 ([490e707](../../commit/490e7079609b54ec2b3fe58b67867e6058d5a84f))
...
- Release v1.1.0 ([6e11377](../../commit/6e11377e948dfc1507c74939a4f8dde16ebc517f))
...
- Release v1.0.0 ([57a1165](../../commit/57a1165769a8e7d82126caf4a9c1643c133c27cf))
...
- Release v0.12.2 ([13b24d4](../../commit/13b24d4cf4c62c41178206e0bd64bcaacafff2ac))
...
- Release v0.12.1 ([b7d2f05](../../commit/b7d2f055601c056330ac22f6b329d72dda811dd4))
...
- Release v0.12.0 ([e64e616](../../commit/e64e6161af04f9afb1e73e52bd92483c2c70176b))
...
- Release v0.11.5 ([0e811f2](../../commit/0e811f25906cd8e7c9375936a80c3d3a09a6c2ba))
...
- Release v0.11.4 ([ddc284e](../../commit/ddc284e88ba7f7ab9a02d1b44b6105ab1a4f7dc6))
...
- Release v0.11.3 ([11fdc51](../../commit/11fdc516ee7cb653ea1a253ca5b79d15145d591b))
...
- Release v0.11.2 ([ecd4d53](../../commit/ecd4d53c43a4dfca46cbcebd1d423096c0cec25d))
...
- Release v0.11.1 ([518ba0e](../../commit/518ba0efda495bed3907065f1c99d3b9cb8d1737))
...
- Release v0.11.0 ([346609d](../../commit/346609d32bd84d7caeeafaebfeb295fd0e4ac5f6))
...
- Release v0.10.0 ([0abf634](../../commit/0abf634aa43e6623199dfbdf30ba10ada3bd87ab))
...
- Release v0.9.0 ([9df68e0](../../commit/9df68e066059f2369b979d385e753f3482b9bdfa))
...
- Release v0.8.3 ([3c95b1e](../../commit/3c95b1efdb27fec0d742aa521725663366ddb506))
...
- Release v0.8.2 ([d06f100](../../commit/d06f1004e8d8353b977da979fc90f957a6bc7432))
...
- Release v0.8.1 ([f3cd814](../../commit/f3cd81449539ecfe7345d8a29bd090495ea0b351))
...
- Release v0.8.0 ([b908059](../../commit/b908059049d2cf0e786731b30ead48dcd7824e27))
...
- Release v0.7.3 ([d239108](../../commit/d23910835372d945cfe469ee8c71bc0cd26a8ddf))
...
- Release v0.7.2 ([0bb73ef](../../commit/0bb73ef142f120549f8f8ae877912340ad9eeb93))
...
- Release v0.7.1 ([3f3122f](../../commit/3f3122f0cfb4e976160266e8d971817eceed1f46))
...
- Release v0.7.0 ([4c80017](../../commit/4c8001723308d1c5b0fc7cee8be5f2d952ed5963))
...
- Release v0.6.0 ([0866e1b](../../commit/0866e1b2a7e7a3fe6d94d60214aae051256704fd))
...
- Release v0.5.5 ([3ac64a6](../../commit/3ac64a6faddb8d454505c717a4af350cc39664ab))
...
- Release v0.5.4 ([54577d6](../../commit/54577d6e6feb83dc52a9de7dad80105e65cdb3da))
...
- Release v0.5.3 ([909891d](../../commit/909891d6b4f7d4b44e14b331053077313295dac4))
...
- Release v0.5.2 ([780b695](../../commit/780b69591c279d0b8bc5a64d0894329fffb24f27))
...
- Release v0.5.1 ([57b3674](../../commit/57b3674b013ad1166e9b791bba8ca4d585567c5a))
...
- Release v0.5.0 ([e028790](../../commit/e028790271cc3a8d7b213de44aea54fbc30a3801))
...
- Release v0.4.1 ([537a011](../../commit/537a01119c984f4b279c2fbb556f236edc32ccca))
...
- Release v0.4.0 ([e3676f4](../../commit/e3676f4d66eddddbe9166e384ac12ed06cf5632a))
...
- Release v0.3.0 ([e40ac4f](../../commit/e40ac4f87909f8f92a85069a9f0207320e08ddd0))
...
- Release v0.2.2 ([a82842e](../../commit/a82842e4adb16363c019e12cfdbd4f9c37c11936))
...
- Release v0.2.1 ([5a6a7f9](../../commit/5a6a7f9a40efd84bdc01180fa3dba9c8ea67c317))
...
- Release v0.2.0 ([09b6541](../../commit/09b6541ae3993276babf0de79466981b147aaf62))
...
- Release v0.1.0 ([ee89304](../../commit/ee893045ef54014b287081ff1b2ebfad1aba9f3b))
...
- Release v0.0.8 ([d159e51](../../commit/d159e5125fe2a383bdacc180f265455c551f001a))
...
- Release v0.0.7 ([7725b9c](../../commit/7725b9ccfdf961b6e0b4e29928b45f4cd7a63c5d))
...
- Release v0.0.6 ([35fa82b](../../commit/35fa82b633c74f4af8dbcf89179cae66138fc1ad))
...
- Release v0.0.5 ([43a1d6c](../../commit/43a1d6c648611143519cd6235a39cb5dc4532769))
...
- Release v0.0.4 ([17407c4](../../commit/17407c483d8b4b2fd704af4f534af2729729ef9c))
...
- Release v0.0.3 ([595b4c3](../../commit/595b4c36e6a51e68ff276426a2d48ed355422621))
...
- Release v0.0.2 ([0161ac4](../../commit/0161ac4ddd2a65bae17e1c01a68812732c4b7266))
...
- Release v0.0.1 ([834668a](../../commit/834668afce26e721ffd8c813e39f037c14c2b813))
