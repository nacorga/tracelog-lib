...
const tasks = [
  ...
  {
    content: "Update documentation (README.md, API_REFERENCE.md, component READMEs as needed - NEVER CHANGELOG.md)",
...
2. **API_REFERENCE.md** (Comprehensive API documentation)
   - Update if: New config options, new transformer functions, new event types
   - Sections to check: Configuration, Transformers, Event Types

3. **SECURITY.md** (Security & Privacy documentation)
   - Update if: New data capture, PII handling, privacy controls
   - Sections to check: Data Collection, Privacy Controls, Best Practices

4. **BEST_PRACTICES.md** (Usage guidelines)
   - Update if: New patterns, recommendations, common pitfalls discovered
   - Sections to check: Configuration, Testing, Performance

5. **Component-specific READMEs** (Architecture documentation)
   - Check: `src/handlers/README.md`, `src/managers/README.md`, `src/listeners/README.md`
   - Update if: New handler/manager/listener added or existing one significantly changed

6. **CLAUDE.md** (LLM context, only if major architectural change)
   - Update if: New handler patterns, new manager patterns, significant architecture shift

**🚫 CRITICAL - NEVER EDIT**: CHANGELOG.md is auto-generated by GitHub Actions CI/CD workflow based on conventional commit messages. Manual edits will be overwritten on next release.
...
Required Updates:
□ README.md - Configuration/Event Types/Usage (if applicable)
□ API_REFERENCE.md - API documentation (if config/transformers/events added)
□ SECURITY.md - Security/Privacy section (if data capture changed)
□ BEST_PRACTICES.md - Usage guidelines (if new patterns added)
...
🚫 NEVER UPDATE: CHANGELOG.md
   ⚠️  Auto-generated by GitHub Actions CI/CD workflow
   ⚠️  Based on conventional commit messages
   ⚠️  Manual edits will be OVERWRITTEN on next release
```
...
1. Identify what changed:
   - New config options? → Update README.md Config + API_REFERENCE.md
   - New event type? → Update README.md Event Types + API_REFERENCE.md
   - New transformer? → Update API_REFERENCE.md Transformers + BEST_PRACTICES.md
   - Security/PII changes? → Update SECURITY.md
   - New patterns/practices? → Update BEST_PRACTICES.md
...
🚫 NEVER UPDATE: CHANGELOG.md
   - Auto-generated by GitHub Actions CI/CD workflow
   - Based on conventional commit messages (feat:, fix:, etc.)
   - Manual edits will be OVERWRITTEN on next release
   - Commit message quality = changelog quality
```
...
0. Documentation Check (REQUIRED - CLAUDE.md)
   Verify: README.md, API_REFERENCE.md, SECURITY.md, BEST_PRACTICES.md, component READMEs updated as applicable
   🚫 NEVER: CHANGELOG.md (auto-generated by CI/CD from conventional commits)
   Status: [CHECKING...]
