...
**🚫 CRITICAL**: NEVER edit CHANGELOG.md - it's auto-generated by GitHub Actions CI/CD workflow based on conventional commits. When security issues are fixed, document them in SECURITY.md only.
