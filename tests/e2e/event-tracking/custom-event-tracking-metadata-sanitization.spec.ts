...
test.describe('Custom Event Tracking - Metadata Sanitization', () => {
  // TODO: Test HTML tag stripping in string metadata
  ...
  // TODO: Test special character encoding
  test.describe('Special character encoding', () => {
    // Test implementation needed
  });

  // TODO: Test removal of potentially dangerous properties
  test.describe('Dangerous properties removal', () => {
    // Test implementation needed
  });

  // TODO: Test preservation of legitimate content
  test.describe('Legitimate content preservation', () => {
    // Test implementation needed
  });

  // TODO: Test sanitization consistency across different metadata types
