...
describe('EventManager - External Referrer Detection', () => {
  let eventManager: EventManager;
  let storageManager: StorageManager;
  let emitter: Emitter;
  ...
  describe('getExternalReferrer()', () => {
    it('should return "Direct" when referrer is empty', () => {
      ...
      const result = eventManager['getExternalReferrer']();
  ...
  describe('isSameDomain()', () => {
    it('should return true for exact match', () => {
      const result = eventManager['isSameDomain']('example.com', 'example.com');
      expect(result).toBe(true);
    });

    it('should return true for www subdomain', () => {
      const result = eventManager['isSameDomain']('www.example.com', 'example.com');
      expect(result).toBe(true);
    });

    it('should return true for any subdomain', () => {
      const result = eventManager['isSameDomain']('blog.example.com', 'example.com');
      expect(result).toBe(true);
    });

    it('should return true for cross-subdomain comparison', () => {
      const result = eventManager['isSameDomain']('www.example.com', 'blog.example.com');
      expect(result).toBe(true);
    });

    it('should return true for deep subdomain', () => {
      const result = eventManager['isSameDomain']('app.blog.example.com', 'example.com');
      expect(result).toBe(true);
    });

    it('should return false for different domains', () => {
      const result = eventManager['isSameDomain']('google.com', 'example.com');
      expect(result).toBe(false);
    });

    it('should return false for similar but different domains', () => {
      const result = eventManager['isSameDomain']('myexample.com', 'example.com');
      expect(result).toBe(false);
    });

    it('should handle compound TLDs (co.uk)', () => {
      const result = eventManager['isSameDomain']('www.example.co.uk', 'example.co.uk');
      expect(result).toBe(true);
    });

    it('should handle compound TLDs (com.br)', () => {
      const result = eventManager['isSameDomain']('shop.example.com.br', 'example.com.br');
      expect(result).toBe(true);
    });

    it('should return false for different domains with compound TLDs', () => {
      const result = eventManager['isSameDomain']('other.co.uk', 'example.co.uk');
      expect(result).toBe(false);
    });
  });

  describe('getRootDomain()', () => {
    it('should return hostname unchanged for simple domain', () => {
      const result = eventManager['getRootDomain']('example.com');
      expect(result).toBe('example.com');
    });

    it('should extract root domain from www subdomain', () => {
      const result = eventManager['getRootDomain']('www.example.com');
      expect(result).toBe('example.com');
    });

    it('should extract root domain from any subdomain', () => {
      const result = eventManager['getRootDomain']('blog.example.com');
      expect(result).toBe('example.com');
    });

    it('should extract root domain from deep subdomain', () => {
      const result = eventManager['getRootDomain']('app.blog.example.com');
      expect(result).toBe('example.com');
    });

    it('should handle compound TLD (co.uk)', () => {
      const result = eventManager['getRootDomain']('www.example.co.uk');
      expect(result).toBe('example.co.uk');
    });

    it('should handle compound TLD (com.br)', () => {
      const result = eventManager['getRootDomain']('shop.example.com.br');
      expect(result).toBe('example.com.br');
    });

    it('should handle compound TLD (co.jp)', () => {
      const result = eventManager['getRootDomain']('api.example.co.jp');
      expect(result).toBe('example.co.jp');
    });

    it('should handle compound TLD (com.au)', () => {
      const result = eventManager['getRootDomain']('www.example.com.au');
      expect(result).toBe('example.com.au');
    });

    it('should handle compound TLD (org.uk)', () => {
      const result = eventManager['getRootDomain']('blog.example.org.uk');
      expect(result).toBe('example.org.uk');
    });

    it('should handle single-label hostname (localhost)', () => {
      const result = eventManager['getRootDomain']('localhost');
    ...
    it('should return correct root for non-compound TLD with deep subdomain', () => {
      const result = eventManager['getRootDomain']('a.b.c.example.org');
